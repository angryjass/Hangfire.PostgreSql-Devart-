...
namespace Hangfire.PostgreSql
{
    ...
    {
        private readonly PgSqlConnection _existingConnection;
        private readonly Action<PgSqlConnection> _connectionSetup;
        ...
        public PostgreSqlStorage(string nameOrConnectionString, Action<PgSqlConnection> connectionSetup,
        ...
        /// explicit instance of the <see cref="PgSqlConnection"/> class that will be used
        /// to query the data.
        /// </summary>
        /// <param name="existingConnection">Existing connection</param>
        /// <param name="options">PostgreSqlStorageOptions</param>
        public PostgreSqlStorage(PgSqlConnection existingConnection, PostgreSqlStorageOptions options)
        {
            if (existingConnection == null) throw new ArgumentNullException(nameof(existingConnection));
            if (options == null) throw new ArgumentNullException(nameof(options));
            var connectionStringBuilder = new PgSqlConnectionStringBuilder(existingConnection.ConnectionString);
        ...
        public PostgreSqlStorage(PgSqlConnection existingConnection)
        {
            if (existingConnection == null) throw new ArgumentNullException(nameof(existingConnection));
            var connectionStringBuilder = new PgSqlConnectionStringBuilder(existingConnection.ConnectionString);
            if (connectionStringBuilder.Enlist)
        ...
        public override string ToString()
        {
            ...
            try
            {
                var connectionStringBuilder = new PgSqlConnectionStringBuilder(_connectionString);
        ...
        internal PgSqlConnection CreateAndOpenConnection()
        {
            var connectionStringBuilder = new PgSqlConnectionStringBuilder(_connectionString);
            ...
            var connection = new PgSqlConnection(connectionStringBuilder.ToString());
